...
var programList = 
[
'(lambda (solvec9e6f938 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solve97999447 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (_solvece4f8723 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solvec9e6f938 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (_solve72ca375d $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solve0520fde7 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (_solve5521c0d9 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solve007bbfb7 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solvef25fbde4 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solvefcb5c309 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000',
'(lambda (solvef25fbde4 $0)) ; log prior = -6.591674 ; log likelihood = 0.000000', 
'(lambda (concatNAndReflect (solvec9e6f938 $0) true down)) ; log prior = -12.660099 ; log likelihood = 0.000000',
'(lambda (solve50cb2852 $0 teal)) ; log prior = -9.230731 ; log likelihood = 0.000000',
'(lambda (reflect (reflect $0 false) true)) ; log prior = -12.660099 ; log likelihood = 0.000000',
'(lambda (reflect $0 true)) ; log prior = -7.977968 ; log likelihood = 0.000000',
'(lambda (solve007bbfb7 (blocksToMinGrid (findBlocksByCorner $0)))) ; log prior = -12.190096 ; log likelihood = 0.000000',
'(lambda (concatNAndReflect $0 true down)) ; log prior = -9.364262 ; log likelihood = 0.000000',
'(lambda (concatNAndReflect (solvec9e6f938 $0) true down)) ; log prior = -12.660099 ; log likelihood = 0.000000',
'(lambda (concatNAndReflect (solvec9e6f938 $0) true down)) ; log prior = -12.660099 ; log likelihood = 0.000000',
'(lambda (solve50cb2852 $0 black)) ; log prior = -9.230731 ; log likelihood = 0.000000',
'(lambda (reflect (reflect $0 false) true)) ; log prior = -12.660099 ; log likelihood = 0.000000',
'(lambda (concatNAndReflect $0 true up)) ; log prior = -9.364262 ; log likelihood = 0.000000',
'(lambda (reflect $0 false)) ; log prior = -7.977968 ; log likelihood = 0.000000',
'(lambda (duplicateN $0 left 1)) ; log prior = -10.922407 ; log likelihood = 0.000000',
'(lambda (blocksToMinGrid (findBlocksByCorner $0))) ; log prior = -8.894259 ; log likelihood = 0.000000',
'(lambda (solve50cb2852 $0 red)) ; log prior = -9.230731 ; log likelihood = 0.000000',
'(lambda (grow $0 3)) ; log prior = -9.536113 ; log likelihood = 0.000000',
'(lambda (concatNAndReflect $0 true down)) ; log prior = -9.364262 ; log likelihood = 0.000000',
]
