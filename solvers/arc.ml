...
ignore(primitive "make_cmap" (tcolorpair @> tcolorpair @> tcolorpair @> tcolorpair @> tcmap)) ;;

(* ticmap *)

ignore(primitive "make_icmap" (tintcolorcpair @> tintcolorcpair @> tintcolorcpair @> tintcolorcpair @> ticmap)) ;;
