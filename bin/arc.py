...
from dreamcoder.domains.arc.experiment_output import load_experiment_output
from dreamcoder.domains.arc.main import main
...
if __name__ == '__main__':
    ...
    # main(args)
    load_experiment_output(arc_options)
